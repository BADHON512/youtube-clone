...
export default function Genres() {
  ...
  return (
    <div className="fixed  z-0 w-full overflow-x-scroll">
      <div className="h-[8vh] bg-[#000000] w-full  flex justify-start items-center gap-x-2">
        <div
          onClick={() => setColor(1)}
          className={`h-[4vh] min-w-[5vw] rounded-md ${
            Color == 1
              ? "bg-[#fff5f5d7] text-black "
              : "bg-[#e0d6d62d]  hover:bg-[#e0d6d665] transition  duration-400 ease-in-out"
          } flex justify-center items-center  cursor-pointer px-2`}
        >
